<template>
	...
	<div>
		<ModalViewImage v-if="isLoggedIn && hasImage">  </ModalViewImage>
		<ModalEditTitleAndDesc>  </ModalEditTitleAndDesc>
...
import ModalEditTitleAndDesc from "./ModalEditTitleAndDesc"
